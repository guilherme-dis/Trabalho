...
public class Main {
    public static void main(String[] args) {
        ...
        clientes.add(new Cliente("1", "123456789", "João", "Rua 1", "123456789", new ArrayList<>(),null));
        clientes.add(new Cliente("2", "987654321", "Maria", "Rua 2", "987654321", new ArrayList<>(),null));
        clientes.add(new Cliente("3", "123987456", "José", "Rua 3", "123987456", new ArrayList<>(),null));
        clientes.add(new Cliente("4", "456789123", "Ana", "Rua 4", "456789123", new ArrayList<>(),null));
        clientes.add(new Cliente("5", "789123456", "Pedro", "Rua 5", "789123456", new ArrayList<>(),null));

        //Create four Vendas
        ArrayList<Venda> vendas = new ArrayList<>();
        vendas.add(new Venda(781, clientes.get(0),null, 100));
        ...
        estilistas.add(new Estilista("1", "123456789", "35984114444", "Rua 1", "Joao", new ArrayList<>()));
        estilistas.add(new Estilista("2", "987654321", "35984114444", "Rua 2", "Mario", new ArrayList<>()));
        estilistas.add(new Estilista("3", "123987456", "35984114444", "Rua 3", "Guilherme", new ArrayList<>()));
        estilistas.add(new Estilista("4", "456789123", "35984114444", "Rua 4", "Luiz", new ArrayList<>()));
        estilistas.add(new Estilista("5", "789123456", "35984114444", "Rua 5", "Joanderson", new ArrayList<>()));
        ...
        supervisores.get(1).setCostureiras(new ArrayList<>(Arrays.asList(costureiras.get(2))));
        ...
        costureiras.get(2).setRoupas(new ArrayList<>(Arrays.asList(roupas.get(2))));
        ...
        clientes.get(0).solicitarRoupa("Vestido Vermelho", 2);
        Roupa roupa = estilistas.get(0).projetaRoupa("Vestido Vermelho");
        Roupa roupaProduzida = costureiras.get(0).criaRoupa(roupa);
        costureiras.get(0).finalizarProducaoDaRoupa(roupaProduzida,estoque);
        Venda venda = supervisores.get(0).venderPecaAoCliente(estoque,roupaProduzida,2,clientes.get(0));
